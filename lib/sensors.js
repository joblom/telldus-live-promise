...
module.exports = function (api) {
  ...
  function list(params) {
    params = params || {includeValues: 1, includeScale: 1};
    return api.request('/sensors/list?' + querystring.stringify({includeValues: params.includeValues, includeScale: params.includeScale}));
  }
